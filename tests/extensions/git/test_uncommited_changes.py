...
from civis_jupyter_notebooks.extensions.git.uncommitted_changes import (
    UncommittedChangesHandler,
)
...
class UncommittedChangesHandlerTest(unittest.TestCase):
    ...
    def test_get_will_return_200_even_with_error(self, civis_git):
        civis_git.return_value.is_git_enabled.return_value = True
        civis_git.return_value.has_uncommitted_changes.side_effect = CivisGitError(
            "dummy error"
        )
